...
class Person(models.Model):
    ...
    bonus_package = models.CharField(max_length=200, null=True, choices=PACKAGE)
...
class TableAdmin(admin.ModelAdmin):
    list_display= ('name','lastname', 'end_user','mng_end_user','position','email', 'status', 'bonus_package')
class Meta:
